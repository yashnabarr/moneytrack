...
function openDocPage(title, bodyHtml) {
  const html = `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/>
    ...
    <style>
      ...
      .logo{width:40px;height:40px;background:#006c49;color:#fff;border-radius:12px;display:flex;align-items:center;justify-content:center;}
    ...
    <body><div class="wrap">
      <div class="brand"><span class="logo">M</span> MoneyMint</div>
      <div class="card">${bodyHtml}</div>
      <p style="text-align:center;color:#6c7a71;font-size:13px;margin-top:24px;">© 2026 MoneyMint Personal Finance.</p>
    </div></body></html>`;
...
const DOCS = {
  help: ["Help & Support", `<h1>Help &amp; Support</h1>
    <p>Welcome to the MoneyMint Help Center. Here are answers to common questions.</p>
    ...
    <h2>Contact</h2>
    <p>Need more help? Email <a href="mailto:support@moneymint.example">support@moneymint.example</a>.</p>`],
  privacy: ["Privacy Policy", `<h1>Privacy Policy</h1><p>MoneyMint stores all of your financial data locally in your own browser using <b>localStorage</b>. We do not collect, transmit, or sell your data.</p><h2>What we store</h2><p>Transactions, budgets, goals, and your sign-in name — all on your device only.</p><h2>Your control</h2><p>You can clear all data at any time from Settings, or by clearing your browser storage.</p>`],
  terms: ["Terms of Service", `<h1>Terms of Service</h1><p>MoneyMint is provided as-is for personal finance tracking. By using it you agree to use it responsibly.</p><h2>No financial advice</h2><p>MoneyMint is a tracking tool and does not provide financial, tax, or investment advice.</p>`],
  contact: ["Contact Us", `<h1>Contact Us</h1><p>We'd love to hear from you.</p><h2>Support</h2><p><a href="mailto:support@moneymint.example">support@moneymint.example</a></p><h2>Sales</h2><p><a href="mailto:hello@moneymint.example">hello@moneymint.example</a></p>`],
};
